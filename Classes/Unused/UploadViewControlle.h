...
#import "ABCRegistrationView.h"


@interface UploadViewController : UIViewController<UIImagePickerControllerDelegate, UINavigationControllerDelegate, ABCRegistrationViewDelegate> {
