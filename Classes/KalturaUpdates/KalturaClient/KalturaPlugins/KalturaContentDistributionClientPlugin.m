...
- (id)init
{
    ...
    self->_isDefaultEqual = KALTURA_UNDEF_BOOL;
    self->_statusEqual = KALTURA_UNDEF_INT;
    return self;
}
...
{
    self.isDefaultEqual = [KalturaSimpleTypeParser parseBool:aPropVal];
}
...
- (void)toParams:(KalturaParams*)aParams isSuper:(BOOL)aIsSuper
{
    ...
    [aParams addIfDefinedKey:@"isDefaultEqual" withBool:self.isDefaultEqual];
