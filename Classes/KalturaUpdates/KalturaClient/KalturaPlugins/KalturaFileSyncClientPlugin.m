...
- (id)init
{
    ...
    self->_fileSizeGreaterThanOrEqual = KALTURA_UNDEF_INT;
    self->_fileSizeLessThanOrEqual = KALTURA_UNDEF_INT;
    return self;
}
...
{
    self.fileSizeGreaterThanOrEqual = [KalturaSimpleTypeParser parseInt:aPropVal];
}

- (void)setFileSizeLessThanOrEqualFromString:(NSString*)aPropVal
{
    self.fileSizeLessThanOrEqual = [KalturaSimpleTypeParser parseInt:aPropVal];
}
...
- (void)toParams:(KalturaParams*)aParams isSuper:(BOOL)aIsSuper
{
    ...
    [aParams addIfDefinedKey:@"fileSizeGreaterThanOrEqual" withInt:self.fileSizeGreaterThanOrEqual];
    [aParams addIfDefinedKey:@"fileSizeLessThanOrEqual" withInt:self.fileSizeLessThanOrEqual];
}
